        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('store.handicraft')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        {{--{{       First Row         }}--}}
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="handicraft_name" name="handicraft_name"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="handicraft_code" name="handicraft_code" class="form-control">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="handicraft_qty" name="handicraft_qty" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" id="handicraft_thumbnail" onChange="mainThamUrl(this)" name="handicraft_thumbnail" class="form-control">
                                                        @error('handicraft_thumbnail')
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                        <img src="" id="mainThmb">
                                                    </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="handicraft_img[]" class="form-control" multiple="" id="multiImg">
                                                        @error('handicraft_img')
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="btn btn-rounded btn-primary mb-5" value="Add Handicraft" >                                </div>
                            </form>
