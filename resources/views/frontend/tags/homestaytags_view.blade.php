                    ...
                    <div id="myTabContent" class="tab-content category-list">
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row">
                                    @foreach($homestay as $agro)
                                        <div class="col-sm-6 col-md-4 wow fadeInUp">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="{{url('/product/homestay/details/'. $agro->id.'/'. $agro->slug)}}">
                                                                <img  src="{{asset($agro->homestay_thumbnail)}}" alt=""></a> </div>
                                                        <!-- /.image -->
                                                        @php
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="{{url('/product/homestay/details/'. $agro->id.'/'. $agro->slug)}}">{{$agro->name}}</a></h3>
                                            ...
                                            <div class="product-list product">
                                                <div class="row product-list-row">
                                                    <div class="col col-sm-4 col-lg-4">
                                                        <div class="product-image">
                                                            <div class="image"> <img src="{{asset($agro->homestay_thumbnail)}}" alt=""> </div>
                                                        </div>
                                                        <!-- /.product-image -->
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col col-sm-8 col-lg-8">
                                                        <div class="product-info">
                                                            <h3 class="name">
                                                                <a href="{{url('/product/homestay/details/'. $agro->id.'/'. $agro->slug)}}">{{$agro->name}}</a>
                                                            </h3>
                                                            <div class="rating rateit-small"></div>
                                                            @if($agro->discount_price == NULL)
                                                                <div class="product-price"> <span class="price">Nu. {{$agro->selling_price}} </span></div>
