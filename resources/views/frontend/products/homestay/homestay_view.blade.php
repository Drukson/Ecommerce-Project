    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li><a href="#">Agro</a></li>
                <li class='active'>{{$homestay->name}}</li>
            </ul>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                ...
                                <div id="owl-single-product">
                                    @foreach($homestayimage as $multi)
                            ...
                            <div class="product-info">
                                ...
                                <div class="stock-container info-container m-t-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="stock-box">
                                                <span class="btn btn-info mb-5">{{$homestay->available_from}}</span>
                                            </div>
                                        </div>
                                    </div><!-- /.row -->
                                </div><!-- /.stock-container -->
                                <div class="stock-container info-container m-t-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="stock-box">
                                                <span class="btn btn-info mb-5">{{$homestay->available_to}}</span>
                                            </div>
                                        </div>
                                    </div><!-- /.row -->
                                </div><!-- /.stock-container -->
                                ...
                                <div class="stock-container info-container m-t-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="stock-box">
                                                <span class="btn btn-rounded btn-info mb-5">{{$homestay->no_of_rooms}}</span>
                                            </div>
                                        </div>
                                    </div><!-- /.row -->
                                </div><!-- / Room Available  -->
                                ...
                                <div class="price-container info-container m-t-20">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                @if($homestay->discount_price == NULL)
                                                    <span class="price">Nu. {{$homestay->selling_price}}</span>
                                                @else
                                                    <span class="price">Nu. {{$homestay->selling_price}}</span>
                                                    <span class="price-strike">Nu. {{$homestay->discount_price}} </span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <div class="tab-content">
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">{!! $homestay->long_desc !!} </p>
                                    </div>
                                </div><!-- /.tab-pane -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img  src="{{asset($homestay->homestay_thumbnail)}}" alt=""></a>
                                        </div><!-- /.image -->
