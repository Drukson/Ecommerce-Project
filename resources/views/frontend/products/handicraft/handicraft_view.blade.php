...
@section('content')
@section('title')
    {{$handicraft->handicraft_name}} Product Details
@endsection
    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li><a href="#">Agro</a></li>
                <li class='active'>{{$handicraft->handicraft_name}}</li>
            </ul>
                    ...
                    <div class="row  wow fadeInUp">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                ...
                                <div id="owl-single-product">
                                    @foreach($handicraftimage as $multi)
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                <h1 class="name">{{$handicraft->handicraft_name}}</h1>
                                ...
                                <div class="price-container info-container m-t-20">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                @if($handicraft->discount_price == NULL)
                                                    <span class="price">Nu.{{$handicraft->selling_price}}</span>
                                                @else
                                                    <span class="price">Nu.{{$handicraft->discount_price}}</span>
                                                    <span class="price-strike">Nu.{{ $handicraft->selling_price}}</span>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div class="tab-content">
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">{!! $handicraft->long_desc !!} </p>
                                    </div>
                                </div><!-- /.tab-pane -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img  src="{{asset($handicraft->handicraft_thumbnail)}}" alt=""></a>
                                        </div><!-- /.image -->
