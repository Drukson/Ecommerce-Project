        ...
        <div class="sign-in-page">
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8 create-new-account">
                    ...
                    <form method="POST" action="{{ route('register_customer') }}" class="register-form outer-top-xs" role="form" id="customer_form" style="display:none">
                        @csrf
...
<script>
    function showpage(type){
        ...
        if(type=="seller"){
            window.location='{{route('seller_registration')}}';
        }
    }
</script>
