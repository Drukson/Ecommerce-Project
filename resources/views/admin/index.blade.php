                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">Nu{{ $today  }} <small class="text-success"><i class="fa fa-caret-up"></i> Btn</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">Nu.{{ $month }} <small class="text-success"><i class="fa fa-caret-up"></i> Btn</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">Nu{{ $year }} <small class="text-danger"><i class="fa fa-caret-down"></i> Btn</small></h3>
                        </div>
                    </div>
                </div>
            </div>
